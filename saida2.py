...
gyro_track(1.2, 2.5, 300, 200, 0, 30, 80, 20, 620)
gyro_track(1.2, 2.5, 100, 100, 15, 30, 80, 20, 420)
gyro_track(1.2, 2.5, 300, 200, 0, 30, 80, 20, 700)
wait(500)
move_time(50, 50, 1000)
gyro_track(1.2, 2.5, 200, 100, 0, 30, 80, 20, -192)
wait(500)
gyro_turn_pd(90, 1.2, 3, 60, 25)
motord.run_time(600, 1200)
motord.reset_angle(0)
c_motor(100, 1600)
gyro_track(1.2, 2.5, 200, 100, 90, 20, 60, 20, 240)
d_motor(50, -138) 
c_motor(100, -910)
wait(1000)
c_motor(100, 1100)
...
d_motor(100, -250)
wait(500)
gyro_track(1.2, 2.5, 300, 300, 141, 30, 80, 20, 700)
c_motor(100, -600)
gyro_turn_pd(-15, 1.2, 3.5, 60, 30)
c_motor(100, -400)
gyro_turn_pd(15, 1.2, 3.5, 60, 30)
gyro_track(1.2, 2.5, 200, 100, 141, 30, 100, 20, -200)
