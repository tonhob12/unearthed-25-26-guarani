...
gyro_track(1.2, 2.5, 300, 200, 0, 30, 70, 20, 620)
gyro_track(1.2, 2.5, 100, 100, 15, 30, 70, 20, 420)
gyro_track(1.2, 2.5, 300, 200, 0, 30, 70, 20, 700)
wait(500)
move_time(50, 50, 1000)
gyro_track(1.2, 2.5, 200, 100, 0, 30, 70, 20, -192)
wait(500)
gyro_turn_pd(90, 1.2, 3, 60, 25)
motord.run_time(600, 1200)
motord.reset_angle(0)
c_motor(100, 1600)
gyro_track(1.2, 2.5, 200, 100, 90, 20, 40, 20, 240)
d_motor(50, -138) 
c_motor(100, -910)
wait(1000)
c_motor(100, 1100)
gyro_track(1.2, 2.5, 200, 100, 90, 30, 60, 20, -198)
d_motor(100, -250)
wait(500)
gyro_track(1.2, 2.5, 300, 300, 140, 30, 60, 20, 700)
c_motor(100, -600)
gyro_turn_pd(-15, 1.2, 3.5, 60, 30)
c_motor(100, -400)
gyro_turn_pd(15, 1.2, 3.5, 60, 30)
gyro_track(1.2, 2.5, 200, 100, 140, 30, 80, 20, -200)
gyro_track(1.2, 2.5, 200, 200, 90, 30, 80, 20, -500)
gyro_track(1.2, 2.5, 300, 300, 10, 30, 80, 20, -2000)