...
gyro_turn_pd(-30, 1.6, 7.2, 80, 40)
gyro_track(2.2, 4.2, 300, 300, -30, 40, 80, 30, 650)
gyro_turn_pd(30, 1.6, 7.2, 80, 40)
gyro_track(2.2, 4.2, 25, 25, 0, 25, 50, 25, 120)
c_motor(100, 130)
wait(500)
for i in range(3):
    c_motor(80, 260)
    ...
    wait(100)
c_motor(100, -130)
gyro_turn_pd(60, 1.6, 7.2, 80, 40)
d_motor(100, 220)
move_time(80, 80, 2100)
d_motor(100,1460)
gyro_track(2.2, 4.2, 300, 300, 60, 40, 80, 30, -250)
gyro_turn_pd(-60, 1.6, 7.2, 80, 40)
