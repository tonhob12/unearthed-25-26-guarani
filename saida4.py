...
gyro_track(2.2,4.2,200,200,0, 40, 80, 30, 300)
gyro_turn_pd(-30, 1.2, 3, 80, 30)
gyro_track(2.2, 4.2, 200, 200, -30, 40, 80, 30, 655)
gyro_turn_pd(30, 1.2, 3, 80, 30)
gyro_track(2.2, 4.2, 200, 200, 0, 40, 80, 30, 107)
for i in range(3):
    c_motor(40, 400)
    c_motor(80, -400)
gyro_turn_pd(57, 1.2, 3.4, 80, 30)
d_motor(50, 230)
move_time(80, 80, 2000)
d_motor(60,1450)
gyro_track(2.2, 4.2, 200, 100, 57, 40, 80, 30, -250)
gyro_turn_pd(-57, 1.2, 3.4, 80, 30)
gyro_track(2.2, 4.2, 200, 100, 0, 40, 80, 30, -800)
gyro_track(2.2, 4.2, 200, 100, -70, 40, 80, 30, -1500)